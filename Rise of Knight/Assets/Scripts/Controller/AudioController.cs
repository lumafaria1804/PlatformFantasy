...
public class AudioController : MonoBehaviour
{
    ...
    public void PlayBMG(AudioClip audio, bool loop = true, float volume = 0.3f)
    {
    ...
    /// <summary>
    /// Toca um som e destrói o objeto alvo quando o som acaba.
    /// </summary>
    ...
    {
        //Criar objeto temporário só para o som
